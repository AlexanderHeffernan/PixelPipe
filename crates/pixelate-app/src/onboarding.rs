...
const STARTER_PALETTE: &str = "pixelate-starter";
...
/// Opens a `Pixelate` project or initializes the selected folder with starter resources.
///
/// # Errors
///
...
fn starter_palette() -> Palette {
    Palette {
        ...
        name: "Pixelate Starter".to_owned(),
        transparent_index: 0,
        colors: vec![
            [0, 0, 0, 0],
            [30, 24, 37, 255],
