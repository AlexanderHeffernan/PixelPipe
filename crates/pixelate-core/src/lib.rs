...
pub const RECIPE_SCHEMA: &str = "pixelate.recipe/v1";
pub const VALIDATION_SCHEMA: &str = "pixelate.validation/v1";
...
mod tests {
    ...
    fn synthetic_fixture_matches_golden_hashes() {
        let raster: IndexedRaster =
            serde_json::from_str(include_str!("../tests/fixtures/m1/tiny-raster.json"))
                .expect("synthetic fixture JSON");
        let golden: BTreeMap<String, String> =
            serde_json::from_str(include_str!("../tests/fixtures/m1/golden-hashes.json"))
